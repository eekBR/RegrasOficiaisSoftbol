...
\author{WBSC -- SD (autor - Inglês)\\ César Calderaro (coordenação - tradução - edição) \\ Emílio E. Kavamura (em adaptação)}
\date{2023}
...
\begin{document}
	...
	\maketitle
	\tableofcontents*
	%\input{2022-2025-ptbr} % Norma 2022-2025 em conversão para LaTeX

%	\input{2017-2021-corpo.tex} % Norma 2018-2021 em conversão para LaTeX
