...
\begin{enumerate}[label=(\alph*)]
	...
	\begin{center}
		...
		\clip (-70,-80) rectangle ++(140,140);

		\begin{scope}[line width =.05]
		% home plate vertix
		\draw [red](0,-43) circle(1);

		% first base
		\draw ($(0,-43)+(45:58.75)$)--++(-45:1.25)--++(45:1.25)--++(135:2.5)--++(-135:1.25)--++(-45:1.25);
		% third base
		\draw ($(0,-43)+(135:58.75)$)--++(45:1.25)--++(135:1.25);

		% second base
		\draw ($(0,-43)+(45:60)+(135:58.75)$)--++(-135:1.25)--++(135:1.25);
		\end{scope}

		\begin{scope}[line width =.17]
		% pitcher circle
		\draw (0,0) circle(8);
		...
		% grass line
		\begin{scope}
		\clip ($(0,-43)+(45:30)$)--++(45:208) arc (45:135:238) --++(-45:208);
		\draw (0,0) circle(60);
		\end{scope}

		% outfield fence minimums
		\draw ($(0,-43)+(45:30)$)--++(45:220) arc (45:135:250)--++(-45:220);;
		\draw ($(0,-43)+(45:238)$) arc (45:135:238);

		\draw ($(0,-43)+(45:6)$) -- ++(45:54)--++(135:60)--++(-135:60)--++(-45:54);

		\draw ($(0,-43)+(-45:30)$) --++( 45:190);
		\draw ($(0,-43)+(-135:30)$)--++(135:190);

		\draw (0,-73) --++( 12.5,0)--++( 45:20);
		\draw (0,-73) --++(-12.5,0)--++(135:20);

		% coach box third base
		\draw ($(0,-43)+(135:60)+(-135:12)$)--++(45:3)--++(-45:15)--++(-135:3);

		% coach box first base
		\draw ($(0,-43)+(45:60)+(-45:12)$)--++(135:3)--++(-135:15)--++(-45:3);

		% on deck circle first base
		\draw ($(0,-73)+(45:40)+(-45:10)+(135:8)$) circle(2.5);
		% on deck circle third base
		\draw ($(0,-73)+(135:40)+(-135:10)+(45:8)$) circle(2.5);

		% runner line
		\draw ($(0,-43)+(45:30)$) --++(-45:3) -- ++(45:30);

		% batcher box
		\draw ($(0,-43)+(4.21,-3+.21)$) --++(-3,0)--++(0,7)--++(3,0) -- ++(0,-17)--++(-8.5,0)--++(0,17)--++(3,0)--++(0,-7)--++(-3,0);

		\end{scope}

		% third base dugout
		\draw [line width=1.5pt] ($(0,-43)+(135:30)+(-135:30)$) -- ++(-135:10)--++(135:20)--++(45:10);
		\fill [green!70!black] ($(0,-43)+(135:30)+(-135:30)$) -- ++(-135:10)--++(135:20)--++(45:10);

		% first base dugout
		\draw [line width=1.5pt]($(0,-43)+(45:30)+(-45:30)$) -- ++(-45:10)--++(45:20)--++(135:10);
		%\fill [green!70!black]($(0,-43)+(45:30)+(-45:30)$) -- ++(-45:10)--++(45:20)--++(135:10);


		% home plate
		\fill (0,-43) --++(.71,.71)--++(0,1)--++(-1.42,0) -- ++(0,-1)--cycle;

		% pitcher plate
		\fill (0,0) --++(1,0)--++(0,-0.71)--++(-2,0)--++(0,0.71) -- cycle;
...
\begin{enumerate}[label=(\alph*)]
	\item A partir da primeira metade do oitavo \gls{inning} e da metade de cada \gls{inning} subsequente até o término do jogo, a equipe na ofensiva inicia a sua vez de bater com o jogador a quem cabe bater em nono \footnote{ \highlight{ NT: \'ultimo batedor a voltar a bater no momento.} } nessa respectiva metade de \gls{inning} colocado na segunda base como um corredor.
...
\begin{center}
	...
	% coach box third base
	\draw ($(0,-43)+(135:60)+(-135:12)$)--++(45:3)--++(-45:15)--++(-135:3);
	\fill [green!70!black] ($(0,-43)+(135:60)+(-135:12)$)--++(45:3)--++(-45:15)--++(-135:3);

	% coach box first base
	\draw ($(0,-43)+(45:60)+(-45:12)$)--++(135:3)--++(-135:15)--++(-45:3);
	\fill [green!70!black] ($(0,-43)+(45:60)+(-45:12)$)--++(135:3)--++(-135:15)--++(-45:3);
...
\begin{center}
	\begin{tikzpicture}[spy using outlines={circle=20mm, magnification=8, size=10mm, connect spies},scale=.02]
	%	\clip (-70,-80) rectangle ++(140,140);
	...
	\draw [red,line width =.5](0,-43.5) --++(45:270) node[pos=.6, scale=.7,rotate=45, below]{Linha de \textit{Foul}};
	\draw [red,line width =.5](0,-43.5) --++(135:270) node[pos=.6, scale=.7,rotate=-45, below]{Linha de \textit{Foul}};

	% home plate vertix
	\draw [red](0,-43) circle(.01);

	% Territorio FAIR
	\fill [green!70!black, opacity=.5] (0,-43.25) --++(45:250) arc (45:135:250)--++(-45:220);
	...
	\spy[blue!70!black,size=30mm] on ( 0,-.85) in node [fill=white] at (-220,-20);
	\spy[blue!70!black,size=20mm,magnification=15] on (.84,-.04) in node [fill=white] at ( 250,-20);
	\end{tikzpicture}
...
\begin{center}
	...
	\fill [green!70!black, opacity=.5] (0,-43.25) --++(45:250) --++(-45:30) --++(-135:262)--++(-25.5,0)--cycle;
	\fill [green!70!black, opacity=.5] (0,-43.25) --++(135:250) --++(-135:30) --++(-45:262)--cycle;
	...
	\spy[blue!70!black,size=30mm] on (0,-.85) in node [fill=white] at (-220,-10);
	\spy[blue!70!black,size=20mm,magnification=15] on (.84,-.04) in node [fill=white] at (250,-20);
	\end{tikzpicture}
...
\begin{enumerate}[label=(\alph*)]
	\item O capacete para batedor prevenido, batedor, batedor-corredor e corredor deve ter duas orelheiras (uma em cada lado) e tem de ser do tipo que ofereça  segurança igual ou maior do que a proporcionada por capacete inteiramente de plástico, com estofamento na parte interna.

	Um forro que cobre somente as orelhas não atende às especificações de um capacete legal.
...
\begin{center}
	\begin{tikzpicture}[spy using outlines={circle=20mm, magnification=6, size=10mm, connect spies},scale=.04]
	\begin{scope}
	\clip (-70,-80) rectangle ++(140,140);
	...
	%	\draw [red,line width =.25](0,-43.5) --++(45:270) node[pos=.6, scale=.9,rotate=45, above]{Linha de \textit{Foul}};
	%	\draw [red,line width =.25](0,-43.5) --++(135:270) node[pos=.6, scale=.9,rotate=-45, above]{Linha de \textit{Foul}};

	% home plate vertix
	\draw [red](0,-43) circle(.01);

	% Territorio Infield
	\fill [green!70!black, opacity=.5] (0,-43.25) --++(45:60)--++(135:60)--++(-135:60)--cycle;
	...
	\fill (0,0) --++(1,0)--++(0,-0.71)--++(-2,0)--++(0,0.71) -- cycle;
	\end{scope}
	\spy[blue!70!black,size=30mm] on (0,-1.65) in node [fill=white] at (-140,-20);
	\spy[blue!70!black,size=20mm,magnification=10] on (1.65,-.04) in node [fill=white] at (140,-10);
	\end{tikzpicture}
...
\hl{\'E uma \'area circular restrita onde o pr\'oximo batedor (batedor prevenido) dever\'a se manter at\'e que seu turno de bater seja anunciado (consulte o Ap\^endice 1-F para dimens\~oes)}.
...
\begin{center}
	...
	% on deck circle first base
	\draw ($(0,-73)+(45:40)+(-45:10)+(135:8)$) circle(2.5);
	\fill [green!70!black, opacity=.5] ($(0,-73)+(45:40)+(-45:10)+(135:8)$) circle(2.5);
	% on deck circle third base
	\draw ($(0,-73)+(135:40)+(-135:10)+(45:8)$) circle(2.5);
	\fill [green!70!black, opacity=.5] ($(0,-73)+(135:40)+(-135:10)+(45:8)$) circle(2.5);

	\draw [green!70!black,line width=3pt,-stealth](50,-70)--($(0,-73)+(45:40)+(-45:10)+(135:8)$);
	\draw [green!70!black,line width=3pt,-stealth](-50,-70)--($(0,-73)+(135:40)+(-135:10)+(45:8)$);
...
\begin{enumerate}[label=(\alph*)]
	...
	\begin{enumerate}[label=\roman*.]
		...
		\item  Bonés, viseiras e fitas para \hl{cabe\c{c}a (tiaras) s\~ao opcionais para jogadoras do sexo feminino e e as jogadoras s\~ao livres para escolherem qual deles desejam usar.

			Se mais de um tipo for usado, todas as pe\c{c}as t\^em de ser da mesma cor, e cada pe\c{c}a do mesmo tipo tem de ser da mesma cor e estilo das cores do uniforme da equipe.}

		\hl{O uso de viseiras de pl\'astico ou material duro (que possa quebrar e ou machucar o atleta) n\~ao \'e permitido}.
	...
	\begin{enumerate}[label=\roman*.]
		\item Um jogador pode usar uma camiseta interna colorida (pode ser branca).

		Não é necessário que todos os jogadores usem camiseta interna, porém se um deles usar, todas as camisetas internas usadas têm de ser semelhantes.

		Nenhum jogador pode usar camiseta que tenha as mangas expostas à vista desgastadas, desfiadas ou rasgadas.

		\item \hl{Pode ser usada uma ou duas mangas para aquecimento (mangas de compress\~ao ou 'manguitos'), mas ela ser\'a tratada da mesma maneira que uma camiseta de mangas compridas}.

		\hl{No caso de duas mangas,ambos os bra\c{c}os t\^em de estar cobertos, e as duas mangas t\^em de ser da mesma cor s\'olida do uniforme do time e das camisetas internas de mangas usadas por qualquer jogador desse time}.
	\end{enumerate}
...
\begin{center}
	\includegraphics[width= .35\textwidth]{fig/lineup}
\end{center}
	...
	\begin{enumerate}[label=\roman*.]
		...
		\begin{center}
			...
			\raisebox{-40mm}{
				...
				%	\spy[blue!70!black,size=30mm] on (0,-1.65) in node [fill=white] at (-140,-20);
				%	\spy[blue!70!black,size=20mm,magnification=10] on (1.65,-.04) in node [fill=white] at (140,-10);
				%	\draw (-40,-60) to[grid with coordinates] (50,50);


				\node at (0,0) [above]{1};
				\node at (0,-55) [above]{2};
				\node at (30,-5) [above]{3};
				\node at (25,30) [above]{4};
				\node at (-40,0) [above]{5};
				\node at (-25,30) [above]{6};
				\node at (-50,40) [above]{7};
				\node at (0,60) [above]{8};
				\node at (55,30) [above]{9};
				\end{tikzpicture}
			}
		\end{center}
		...
		%	 \multicolumn{3}{|l|}{Campeonato}\\\hline
		%	Jogo do dia & data & local\\\hline
		%	\hspace{40mm}&\hspace{40mm}&\hspace{25mm}\\\hline
		%	\multicolumn{3}{|c|}{\hspace{35mm} $\times$ \hspace{35mm}.}\\\hline
		%	\multicolumn{3}{|c|}{\tiny\hspace{15mm}visitante \hspace{50mm}\tiny local\hspace{14.2mm}.}\\\hline
		%	\end{tabular}}
		%
		%	\begin{tabular}{|*6{l|}}\hline
		%	\multicolumn{6}{|l|}{Equipe}\\\hline
		%	Ordem & Pos. & Titulares & Núm. & Suplentes &Núm. \\\hline
		%	1 & & \textcolor{black!30}{Nome completo} &  & \textcolor{black!30}{Nome completo}& \\\hline
		%	2 & & & & &  \\\hline
		%	3 & & & & &  \\\hline
		%	4 & & & & &  \\\hline
		%	5 & & & & &  \\\hline
		...
		%	9 & & & & &  \\\hline
		%	10 & & & & &  \\\hline
		%	\multicolumn{2}{|l}{Técnico}& & & &  \\\hline
		%	\multicolumn{2}{|l}{Cap.}& & & &  \\\hline
		%	\end{tabular}
		%}
...
\begin{landscape}
	...
	{\footnotesize\begin{tabular}{p{20mm}p{50mm}p{156mm}}
			...
			\\[2mm]
			3.1.9, 3.1.12. 3.2.5 d e 3.2.8 &  Reingresso Ilegal
			&
...
\subsection{ARREMESSO LEGAL (ENTREGA)}
\begin{description}
...
{\footnotesize\begin{tabular}{p{15mm}p{50mm}p{100mm}}
		Regra& Descrição & Efeito\\\hline
		4.3.1 a 4.3.7 & Por uma infração das Regras 4.3.1 a 4.3.7 --Movimentos de arremesso impróprios [exceção para os efeitos expostos acima pelas Regras 4.3.3 (k)  , 4.3.5 e 4.3.6 (b) ] resultam em um Arremesso Ilegal sendo declarado

		& Isto é uma Bola Morta Demorada, e devem ser aplicadas as seguintes normas e penalidades.
		{
			\begin{enumerate}[label=(\alph*)]
...
\subsection{\textit{hitbypitch} (ATINGIDO POR ARREMESSO)}
...
{\footnotesize\begin{tabular}{p{15mm}p{60mm}p{90mm}}
		Regra& Descrição & Efeito\\\hline
		5.10.3 (a) (vii a x) & Deixa a base antecipadamente numa bola \gls{fly}, omite uma base ou tenta chegar à segunda base ou omite o \gls{homeplate}]  & corredor não será declarado \gls{out}, a menos que a equipe na defensiva faça uma apelação legal.
		...
		\\ 5.10.3 (a) (xiii) & Corredores mudam de posições nas bases] & Esta é uma jogada de a\-pe\-la\-ção.
		...
		\\  5.10.3 (c) (i), (c) (ii) e (c) (iii)] && Se essa Interferência, na opinião do árbitro, é uma evidente tentativa de evitar uma jogada dupla, o corredor subsequente imediato também deve ser declarado \gls{out}

		\\ 5.10.3 (d) & Interferência do árbitro] & Deve ser sinalizada uma Bola Morta Demorada; a bola permanece viva até a conclusão da jogada.
