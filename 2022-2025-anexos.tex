...
{\footnotesize
	\begin{longtable}{|p{30mm}|p{140mm}|}\\
		...
		\multicolumn{1}{|c|}{\textbf{Nome}} & \multicolumn{1}{c|}{\textbf{Detalhes}} \\\hline
		\endfirsthead
		\multicolumn{2}{c}%
		{{\bfseries \tablename\ \thetable{} -- continuação da página anterior}} \\\hline \hline \multicolumn{1}{|c|}{\textbf{Nome}} & \multicolumn{1}{c|}{\textbf{Detalhes}} \\ \hline
		\endhead
		\hline \multicolumn{2}{|r|}{{Continua na página seguinte}} \\ \hline
		\endfoot
		...
		“CATCHER’S BOX” &
	 	...
	 	As linhas são consideradas dentro do \gls{catcher's box}.
		 \\\hline
		“COACHES’ BOXES”&
		É aquela área atrás de uma linha de 4,57m (15 pés) traçada fora do \gls{diamond} (campo).

		A linha é paralela à linha da primeira/terceira base, e está a 3,66m (12 pés) dessas linhas, estendidas das bases em direção ao \gls{homeplate}. \\\hline
		TABELA DE DISTÂNCIAS &
		.

		{
			\begin{tabular}{*{6}{|p{15mm}|p{15mm}}|}\hline
			\multicolumn{2}{|c|}{\multirow{2}{*}{\parbox{38mm}{CATEGORIA}}} &
			\multicolumn{2}{c|}{\parbox{25mm}{"H. PLATE" - "P. PLATE"}}&
			\multicolumn{2}{c|}{\parbox{45mm}{CERCAS DO CAMPO EXTERNO (mínimas)}}\\\cline{3-6}
			\multicolumn{2}{|c|}{}&m&pés&m&pés\\\hline
			Junior Fem. &( 16u) &12,19 & 40 & \multirow{3}{*}{67,06} & \multirow{3}{*}{220} \\\cline{1-4}
			Junior Fem. &( 19u) &\multirow{2}{*}{13,11} & \multirow{2}{*}{43} & &  \\\cline{1-2}
			Mulheres Adulto& & & & &  \\\hline
			Junior Masc. &(16u)& \multirow{3}{*}{14,02} &\multirow{3}{*}{46} &\multirow{3}{*}{76,20} &\multirow{3}{*}{250}  \\\cline{1-2}
			Junior Masc. &(19u)& &&&   \\\cline{1-2}
			Homens Adulto& & &  &&\\\hline
		\end{tabular}}

		\\\hline
		“HOME PLATE” &
		Deve ter cinco lados.
...
\section{ESPECIFICAÇÕES DAS DIMENSÕES}

\begin{center}\footnotesize
	\begin{tikzpicture}
%	\draw (0,0) to[grid with coordinates] (7,8);
	\node at(0,0)[anchor= south west, opacity=.5] {\includegraphics[width=.40\textwidth]{fig/Luva-a}};
	\begin{scope}[stealth-stealth, line width= 2pt,blue]
		\draw (3.4,4.8) -- (7,3.8) node [above,pos=.5, scale=1.5]{A};
		\draw (2.4,3.8) -- (6.8,2.8) node [above,pos=.5, scale=1.5]{B};
		\draw (0.6,7.2) -- (3.2,8.6) node [above,pos=.5, scale=1.5]{C};
		\draw (3.4,4.8) -- (2.4,3.8) node [ below,pos=.2, scale=1.5]{D};
		\draw (2.2,7.4) -- (2.4,3.8) node [right,pos=.5, scale=1.5]{E};
		\draw (3.4,7.6) -- (3.4,4.8) node [right,pos=.3, scale=1.5]{F};
		\draw (1.2,6.4) -- (2.4,3.8) node [left,pos=.5, scale=1.5]{G};
		\draw (1.4,1.2) -- (0,6) node [left,pos=.5, scale=1.5]{I};
		\draw (10.5,.8) -- (10.5,8.1) node [right,pos=.9, scale=1.4]{J};
		\draw (9.5,.8) -- (9.5,7.8) node [right,pos=.8, scale=1.4]{K};
		\draw (8.5,.8) -- (8.5,7.4) node [right,pos=.7, scale=1.4]{L};
		\draw (7.5,.8) -- (7.5,6.9) node [right,pos=.6, scale=1.4]{M};
	\end{scope}

	\begin{scope}[line width= 1pt,blue]
	\draw (3.5,.8) -- (10.75, .8);
	\draw (10.75,8.1) -- (3.8,8.1);
	\draw (9.75,7.8) -- (4.8,7.8);
	\draw (8.75,7.4) -- (5.7,7.4);
	\draw (7.75,6.9) -- (6.5,6.9);
	\end{scope}
	\end{tikzpicture}
...
\begin{enumerate}[label=(\alph*)]
	...
	\includegraphics[height=.20\textheight]{fig/sinais/strike}
	...
	\includegraphics[height=.20\textheight]{fig/sinais/count}
...
%	\includegraphics[height=.20\textheight]{fig/sinais/fair-foul-a} ou
	...
	\includegraphics[height=.20\textheight]{fig/sinais/fair-foul-a}
	...
	\includegraphics[height=.20\textheight]{fig/sinais/out}
	...
	\includegraphics[height=.20\textheight]{fig/sinais/sell-safe-1}
	\includegraphics[height=.20\textheight]{fig/sinais/sell-safe-2}
	...
	\includegraphics[height=.20\textheight]{fig/sinais/time}
	...
	\includegraphics[height=.20\textheight]{fig/sinais/delayed-dead}
	...
	\includegraphics[height=.20\textheight]{fig/sinais/double}
...
\foreach \sinal in {
	...
	ejection-f2,
	ejection-f31}
{\includegraphics[height=.1\textheight]{fig/sinais/\sinal}}
...
\section{REGISTRO DE DADOS (\textit{BOX SCORE})}
		...
		\begin{enumerate}[label=\arabic*)]
			...
			\item A quinta coluna deve indicar a quantidade de assistências (\gls{assists}) dadas nas eliminações por cada defensor. Deve ser creditada uma assistência
